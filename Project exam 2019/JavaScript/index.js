...
openNav.addEventListener("click", () => {
  ...
  document.querySelector(".body__section").style.marginLeft = "200px";
  document.querySelector(".body__section").style.transition = ".2s ease-in";
  //Hide hamburger bar
...
closeNav.addEventListener("click", () => {
  ...
  document.querySelector(".body__section").style.marginLeft = "0px";
  document.querySelector(".body__section").style.transition = ".2s ease-in";
  // Show hamburger bar
